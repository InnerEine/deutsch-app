...
- AI-прокси для диалогов и проверки домашки через Ollama или Gemini
...
Если выбранный AI-провайдер не настроен или недоступен, приложение продолжит работать, но AI-диалоги и AI-проверка домашки будут возвращать понятную ошибку с backend.
